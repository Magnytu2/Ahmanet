...
?>
<style>
/* Style direct pour forcer la couleur du texte */
.container-title, 
.page-title,
...
document.addEventListener('DOMContentLoaded', function() {
    // Récupérer la couleur de texte depuis les variables CSS
    const textColor = getComputedStyle(document.documentElement).getPropertyValue('--text-dark').trim();
    
    // Appliquer directement aux éléments de titre
    const elements = document.querySelectorAll('.container-title, .page-title, #content .container-title, .cpanel-modules .card-header, .cpanel-modules .card-title');
    elements.forEach(function(el) {
        el.style.color = textColor;
        
        // Appliquer également à tous les enfants
